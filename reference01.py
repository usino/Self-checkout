...
dialog1_signal = QtCore.pyqtSignal()     #定義一個無引數的訊號，串列埠設定與子站初始化訊號 
dialog2_signal = QtCore.pyqtSignal()     #定義一個無引數的訊號，串列埠設定與子站初始化訊號 
exit_signal = QtCore.pyqtSignal()     #定義一個無引數的訊號，串列埠設定與子站初始化訊號 
def __init__(self): 
